...
public class Main {
    ...
    public static void different_size_scenarios(){
        ...
        System.out.println("--Arraylist Different Size Scenarios---");
        /////////////////////////////////////////////////
        long start1 = System.nanoTime();
        for (int i = 0; i < 100; i++) {
            small.add(i);
        ...
        System.out.println("Small Size: "+ (end1-start1)+" nanoTime");
        ...
        long end2 = System.nanoTime();
        System.out.println("Middle Size: "+ (end2-start2)+" nanoTime");
        ...
        System.out.println("Large Size: "+ (end3-start3)+" nanoTime");
    }
}
