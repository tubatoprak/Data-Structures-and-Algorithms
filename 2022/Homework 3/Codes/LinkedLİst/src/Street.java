...
public class Street {
    ...
    int street_length;
    /** left land of street */
    LinkedList<Build> landleft = new LinkedList<>();
    /** right land of street */
    LinkedList<Build> landright = new LinkedList<>();
    /** playground land  of street */
    LinkedList<PlayGround> landplay = new LinkedList<>();
    ...
    LinkedList<Integer> controlleft = new LinkedList<>();;
    /**It  holds the building parts of the right land */
    LinkedList<Integer> controlright= new LinkedList<>();;
    /**It  holds the heights of the Left land */
    LinkedList<Integer> heightleft= new LinkedList<>();;
    /**It  holds the heights of the Right land */
    LinkedList<Integer> heightright= new LinkedList<>();;
    ...
    public void display_skyline(){
        ...
        LinkedList<Integer> temp_free = new LinkedList<>();
        for (int i = 0; i < street_length; i++) {
            temp.add(0);
            temp_free.add(0);
        }
     ...
     */
    public boolean controlland(LinkedList<Integer> control, int position, int weight){
     ...
     */
    public void setcontrol(LinkedList<Integer> control, int position, int weight, LinkedList<Integer> controlheight, int height, int select){
