...
public class Street {
    ...
    int street_length;
    /** left land of street */
    LDLinkedList<Build> landleft = new LDLinkedList<>();
    /** right land of street */
    LDLinkedList<Build> landright = new LDLinkedList<>();
    /** playground land  of street */
    LDLinkedList<PlayGround> landplay = new LDLinkedList<>();
    ...
    LDLinkedList<Integer> controlleft = new LDLinkedList<>();
    /**It  holds the building parts of the right land */
    LDLinkedList<Integer> controlright= new LDLinkedList<>();
    /**It  holds the heights of the Left land */
    LDLinkedList<Integer> heightleft= new LDLinkedList<>();
    /**It  holds the heights of the Right land */
    LDLinkedList<Integer> heightright= new LDLinkedList<>();
    ...
    public void display_skyline(){
        ...
        LDLinkedList<Integer> temp = new LDLinkedList<>();
        LDLinkedList<Integer> temp_free = new LDLinkedList<>();
        for (int i = 0; i < street_length; i++) {
            temp.add(0);
            temp_free.add(0);
        }
     ...
     */
    public boolean controlland(LDLinkedList<Integer> control, int position, int weight){
     ...
     */
    public void setcontrol(LDLinkedList<Integer> control, int position, int weight, LDLinkedList<Integer> controlheight, int height, int select){
